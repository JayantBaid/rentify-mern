...
function Profile() {
  ...
  const handleFileUpload = (file) => {
    ...
    // time is added to make file name unique
  ...
  const handleDeleteUser = async () => {
    const confirmToDelete = confirm("Do you really want to delete your account");
    if(confirmToDelete) {
    try {
  ...
  const handleListingDelete = async (listingId) => {
    const confirmToDeleteListing = confirm("Do you really want to delete this listing");
    if(confirmToDeleteListing) {
    try {
  ...
  return (
    ...
    <div className="p-3 max-w-lg mx-auto">
      <h1 className="text-3xl font-semibold my-3 text-center">Profile</h1>
